...
#       ])
        ...
        self.num_phases = 8
        self.contact_phases = np.array([
#            O  S  O  S  O  S  O  S (Overlap/Swing phase)
            [1, 0, 1, 1, 1, 1, 1, 1],   # FR
            [1, 1, 1, 1, 1, 0, 1, 1],   # FL
            [1, 1, 1, 1, 1, 1, 1, 0],   # BR
            [1, 1, 1, 0, 1, 1, 1, 1]    # BL
    ...
    def stance_ticks(self):
        return (self.num_phases / 2) * self.overlap_ticks + self.swing_ticks
    ...
    def phase_length(self):
        return (self.num_phases / 2) * self.overlap_ticks + (self.num_phases / 2) * self.swing_ticks
